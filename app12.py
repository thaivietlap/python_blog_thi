...
users = {
    'user1@example.com': {'username': 'user1', 'password': generate_password_hash('password1'), 'following': set()},
    'user2@example.com': {'username': 'user2', 'password': generate_password_hash('password2'), 'following': set()},
}
...
def index():
    ...
    return render_template('index.html', username=username, users=users, email=email)
